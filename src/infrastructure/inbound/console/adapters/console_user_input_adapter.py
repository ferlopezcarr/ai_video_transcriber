...
class ConsoleUserInputAdapter(UserInputPort):
    def get_user_input(self) -> argparse.Namespace:
        parser = argparse.ArgumentParser(
            description="Transcribe YouTube, TikTok or Instagram video using Whisper."
        )
        ...
        parser.add_argument(
            ...
            help="Choose transcription model (default: faster-whisper)",
        )
        ...
        parser.add_argument(
            ...
            help="LLM model to use for organizing transcription (default: openai/gpt-oss-20b)",
        )
        parser.add_argument(
            "-e",
            "--enrich-text",
